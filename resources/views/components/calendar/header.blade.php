<div class="calendar-header flex justify-between items-center mb-6">
    ...
    <div class="flex items-center space-x-4">
        ...
        <button
            ...
            class="flex items-center space-x-2 px-4 py-2 bg-white/15 backdrop-blur-lg rounded-xl hover:bg-white/25 transition-all duration-300 shadow-lg border border-white/20 text-white font-medium"
